    ...
    >
              ...
              {[
                ...
                <Link
                  ...
                  className={`text-xs font-bold transition-colors uppercase tracking-[0.15em] hover:glow ${
                    item.label === "CV" ? "text-teal-400" : "text-gray-400 hover:text-white"
                  }`}
                >
                  {item.label}
                </Link>
      ...
      <main className="pt-32 px-6">
        ...
        >
            ...
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8">
              <div className="text-center md:text-left">
                ...
                <div className="flex flex-wrap justify-center md:justify-start gap-6 text-sm text-gray-500 uppercase tracking-widest font-bold">
                  <a href="mailto:leonfreshdesign@gmail.com" className="flex items-center gap-2 hover:text-teal-400 transition-colors">
                    <Mail size={16} /> leonfreshdesign@gmail.com
                  </a>
                  <a href="tel:0466463379" className="flex items-center gap-2 hover:text-teal-400 transition-colors">
                    <Phone size={16} /> 0466 463 379
                  </a>
                  <a href="http://www.leonfresh.com" target="_blank" className="flex items-center gap-2 hover:text-teal-400 transition-colors">
              ...
              <div className="flex justify-center md:justify-end">
                ...
                >
                  <div className="flex flex-col items-end">
                    <span className="text-[10px] font-black uppercase tracking-[0.2em] opacity-50 group-hover:opacity-100">Available Offline</span>
                    <span className="text-sm font-bold uppercase tracking-widest">Download PDF CV</span>
                  </div>
            ...
            <div className="md:col-span-1 space-y-16">
              <motion.section variants={itemVariants}>
                ...
                <p className="text-gray-400 leading-relaxed text-sm">
                  Dynamic and creative Web Developer and Graphic Designer with over a decade of experience across tech, finance, and exhibition management. Adept at creating visually appealing and functional designs for high-profile clients. Passionate about AI, automation, and continuous learning.
                </p>
              </motion.section>
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3 text-sm text-gray-400">
                      <Award size={16} className="text-teal-500 shrink-0 mt-0.5" />
                      {ach}
                    </li>
                  ))}
                </ul>
                ...
                <div className="space-y-12">
                  {[
                    ...
                    <div key={i} className="relative pl-8 border-l border-white/10 group">
                      ...
                      <p className="text-sm text-gray-500 font-bold mb-3 uppercase tracking-wider">{exp.company}</p>
              ...
              <motion.section variants={itemVariants}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  {[
                    ...
                    <div key={i} className="bg-white/5 p-6 rounded-2xl border border-white/5 hover:border-teal-500/30 transition-colors">
                      <GraduationCap size={24} className="text-teal-500 mb-4" />
                      <h4 className="text-sm font-bold text-white mb-1">{edu.degree}</h4>
                      <p className="text-xs text-gray-500 uppercase tracking-widest mb-2">{edu.school}</p>
                      <span className="text-[10px] text-teal-400 font-bold">{edu.year}</span>
                    </div>
                  ))}
                </div>
              </motion.section>
          ...
          {/* Contact Section */}
          <motion.section             id="contact"            variants={itemVariants}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
              <div>
                ...
                <p className="text-gray-400 text-lg mb-12 leading-relaxed">
                  Whether you have a specific project in mind or just want to chat about digital possibilities, I&apos;m always open to new opportunities.
                </p>
